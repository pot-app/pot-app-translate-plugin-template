...
if [ "$INPUT_TARGET" = "x86_64-unknown-linux-gnu" ]; then
    ...
    apt-get update
    apt-get install -y libstdc++6:i386 libatomic1:i386 gcc-multilib g++-multilib pkg-config:i386 libssl-dev:i386
    ...
    apt-get install -y --no-install-recommends g++-aarch64-linux-gnu libc6-dev-arm64-cross libssl-dev:arm64 pkg-config:arm64
    ...
    apt-get install -y --no-install-recommends g++-arm-linux-gnueabihf libc6-dev-armhf-cross libssl-dev:armhf libwebkit2gtk-4.0-dev:armhf libgtk-3-dev:armhf patchelf:armhf librsvg2-dev:armhf pkg-config:armhf
